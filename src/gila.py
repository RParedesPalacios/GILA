...
## anchors
parser.add_argument('-anchors',type=float,nargs="+",help='Define the anchors geometry (0.5,0.5,1,1,2,2,0.5,1,1,0.5,1,2,2,1,1,3,3,1,1,4,4,1,1,5,5,1,1,6,6,1,1,7,7,1,1,8,8,1,1,9,9,1,1,10,10,1)',default=[0.5,0.5,1,1,2,2,0.5,1,1,0.5,1,2,2,1,1,3,3,1,1,4,4,1,1,5,5,1,1,6,6,1,1,7,7,1,1,8,8,1,1,9,9,1,1,10,10,1,1,20,20,1,1,30,30,1])
